        ...
        <div class="sheet sub-sheet">
          ...
          <div class="scroll pad16" id="loop-rows">
            ...
            ${editing ? html`
              ...
              <!-- Bug 11 · "Delete this sub route" used to sit here as a
                   swipe-to-delete row. It read as a button and was not one —
                   tapping it did nothing at all, which is why it was
                   reported as broken — and a sub route is deleted from the
                   Plan's own edit mode, where the row being removed is
                   visible in the itinerary it belongs to. One place to
                   delete a thing, and it is not this screen. -->
            ` : (count ? html`
